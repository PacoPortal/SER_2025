...
EXPERIMENT_FOLDER=DUMP_FOLDER+'experim_004_.'+tms+'.'+str(job_id)+'.'+TYPE_EXPERIMENT+'/'
...
for c in checkpoints:
  ...
  for round in range(rondas):
      ...
      df_record2 = df_record2[df_record2['Ground Truth'] != 6]#print(test_df.emotions.value_counts())
