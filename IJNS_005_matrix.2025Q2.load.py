...
DUMP_FOLDER = ROOT_FOLDER+'/dump/'+'experim_005_.20250609010120.801803.cross'
os.chdir(DUMP_FOLDER)


RECORD = '20250609010120.CROSS6.hubert-large-ll60k.record.p'
...
display_confusion_matrix(df_record,'Cross_',id2label)#save plot files
